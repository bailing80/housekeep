...
<body>
	...
	<table border="1" class="table table-striped" style="width: 100%">
		...
		<tr>
			<td>上一级</td>
			<td>
				<select id="parent" name="type_id"style="width: 30%" class="form-control">
			<option value=" ">无上级</option>
			<option value="首页管理A01">首页管理(A01)</option>
			<option value="分类设置B01">分类设置(B01)</option>
			<option value="账号管理C01">账号管理(C01)</option>
			<option value="业务管理D01">业务管理(D01)</option>
			</select>
