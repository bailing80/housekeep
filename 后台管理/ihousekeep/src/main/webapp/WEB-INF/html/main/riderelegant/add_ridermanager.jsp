...
<script type="text/javascript"
	src="<%=baseurl%>/html/main/riderelegant/add_ridermanager.js"></script>
</head>
<body>
	...
	<table border="1" class="table table-striped" style="width: 100%">
		...
		<tr>
			...
			<!-- <td><input id="link_pic" type="text" size="2"
				class="form-control" style="width: 30%"></td> -->
			<td align="left"><select id="user_manager_role_id" style="width: 30%"></select></td>
		</tr>
		<tr>
			<td>上级员工</td>
			<!-- <td><input id="link_pic" type="text" size="2"
				class="form-control" style="width: 30%"></td> -->
			<td align="left"><select id="leader_role_id" style="width: 30%"></select></td>
		</tr>
		<tr>
			<td>是否允许登录</td>
			<!-- <td><input id="link_pic" type="text" size="2"
				class="form-control" style="width: 30%"></td> -->
			<td align="left"><select id="is_login" style="width: 30%">
