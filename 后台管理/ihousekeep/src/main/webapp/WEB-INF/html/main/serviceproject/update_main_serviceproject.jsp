...
<script type="text/javascript" src="<%=baseurl%>/html/main/serviceproject/update_main_serviceproject.js"></script>
</head>
<body>
	...
	<table border="1" class="table table-striped" style="width: 100%">
		...
		<tr>
			<td>是否首页展示</td>
			<td style="text-align: left;"><input id="is_show_1" type="radio" name="is_show" value="1"style="transform:scale(1.2);width:20px;">是<input id="is_show_2" type="radio" name="is_show" value="2" style="transform:scale(1.2);width:20px;">否
			</td>
		</tr>
		<tr>
			<td>起价</td>
