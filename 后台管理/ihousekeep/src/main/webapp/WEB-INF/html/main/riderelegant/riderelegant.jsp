...
<script type="text/javascript"
	src="<%=baseurl%>/html/main/riderelegant/riderelegant.js"></script>
...
<body>
	...
	<div id="nav" class="btn-group">
		<span class="label label-default">员工风采</span>
	</div>
	<div id="fun" class="btn-group" data-toggle="buttons-checkbox">
		<button class="btn btn-primary" id="add_riderelegant"
			style="float: left">添加员工</button>
		<button class="btn btn-primary" id="delete_riderelegant">删除</button>
	</div>
	<div id="content">
