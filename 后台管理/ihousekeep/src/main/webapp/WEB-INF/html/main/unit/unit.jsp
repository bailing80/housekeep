...
<script type="text/javascript" src="<%=baseurl%>/html/main/unit/unit.js"></script>
...
<body>
	...
	<div id="nav" class="btn-group">
		<span class="label label-default">单位计量表</span>
	</div>
	<div id="fun" class="btn-group" data-toggle="buttons-checkbox">
		...
		<input id="querydata" type="text" size="2" class="form-control"
			style="width: 30%" value="" placeholder="输入单位名称查找">
	</div>
	<div id="content">
