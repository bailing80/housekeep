...
function detail_information(id) {
	...
	var parm = {
		title : "查看订单详细信息",
		html : getRootPath()
				+ "/BaseMultiController/toPage.action?page=main/matched_order/matched_order_information_detail",
		width : "70%",
		height : "65%",
		div_obj : $("#new_div"),
		buttons : [ "退出" ],
...
function send_order(id){
	...
	var parm = {
		title : "显示数据",
		html : getRootPath()
				+ "/BaseMultiController/toPage.action?page=main/matched_order/matched_order_rider",
		width : "50%",
		height : "70%",
		div_obj : $("#new_div"),
		buttons : [ "退出" ],
