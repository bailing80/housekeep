...
@Service("T_s_user_menu_Service_r")
@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
public class T_s_user_menu_Service_Impl extends BaseService implements T_s_user_menu_Service_Iface {
@Resource
...
return t_s_user_menu_dao_iface.queryAll_t_s_user_menu(t_s_user_menu);
}
