...
public class Coupon_H_Controler_4X extends BaseMultiController {
	...
	@ResponseBody
	public AppDataModel_Sec getCouponInfo(Coupon_H coupon_H) {

		AppDataModel_Sec appDataModel_Sec = getAppDataMode_sec();
		AppDataModel appDataModel = null;
		try {
			appDataModel = coupon_H_Service_Iface.getCouponInfo(coupon_H);
		} catch (Exception e) {
	...
	@RequestMapping("getCoupon_level_two")
	@ResponseBody
	public AppDataModel_Sec getCoupon_level_two(Coupon_H coupon_H) {

		AppDataModel_Sec appDataModel_Sec = getAppDataMode_sec();
		AppDataModel appDataModel = null;
		try {
			appDataModel = coupon_H_Service_Iface.getCoupon_level_two(coupon_H);
		} catch (Exception e) {
			e.printStackTrace();
		}
