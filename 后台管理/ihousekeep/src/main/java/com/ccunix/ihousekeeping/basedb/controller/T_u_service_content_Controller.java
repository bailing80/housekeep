...
@Controller
@RequestMapping("T_u_service_content_Controller")
public class T_u_service_content_Controller extends BaseMultiController {
@Resource
public T_u_service_content_Service_Iface t_u_service_content_service_iface;
