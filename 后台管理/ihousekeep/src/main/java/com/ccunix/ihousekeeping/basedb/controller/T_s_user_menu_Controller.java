...
@Controller
@RequestMapping("T_s_user_menu_Controller")
public class T_s_user_menu_Controller extends BaseMultiController {
@Resource
public T_s_user_menu_Service_Iface t_s_user_menu_service_iface;
