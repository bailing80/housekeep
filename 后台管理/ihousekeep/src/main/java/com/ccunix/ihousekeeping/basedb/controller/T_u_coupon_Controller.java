...
@Controller
@RequestMapping("T_u_coupon_Controller")
public class T_u_coupon_Controller extends BaseMultiController {
@Resource
public T_u_coupon_Service_Iface t_u_coupon_service_iface;
