...
<script type="text/javascript"
	src="<%=baseurl%>/html/main/manager/manager.js"></script>
...
<body>
	<div id="nav" class="btn-group">
		<span class="label label-default">管理员设置</span>
	</div>
	<div id="fun" class="btn-group" data-toggle="buttons-checkbox">
		<button class="btn btn-primary" id="add_manager" style="float: left">新增</button>
		<button class="btn btn-primary" id="delete_manager">删除</button>
		<button class="btn btn-primary" id="query_manager" style="float: left">查询</button>
		<input id="querydata" type="text" size="2" class="form-control"
			style="width: 30%" placeholder="请输入查询管理员电话......" value="">
	</div>
	<div id="content">
