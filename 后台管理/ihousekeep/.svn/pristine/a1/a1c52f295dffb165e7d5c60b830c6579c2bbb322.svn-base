...
@Controller
@RequestMapping("T_s_advertisement_item_Controller")
public class T_s_advertisement_item_Controller extends BaseMultiController {
@Resource
public T_s_advertisement_item_Service_Iface t_s_advertisement_item_service_iface;
