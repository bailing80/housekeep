...
@Controller
@RequestMapping("T_u_manager_Controller")
public class T_u_manager_Controller extends BaseMultiController {
@Resource
public T_u_manager_Service_Iface t_u_manager_service_iface;
