...
@Controller
@RequestMapping("T_u_service_item_Controller")
public class T_u_service_item_Controller extends BaseMultiController {
@Resource
public T_u_service_item_Service_Iface t_u_service_item_service_iface;
