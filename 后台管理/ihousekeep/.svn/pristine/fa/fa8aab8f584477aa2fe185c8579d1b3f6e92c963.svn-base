...
<script type="text/javascript"
	src="<%=baseurl%>/html/main/coupon_manager/coupon_manager.js"></script>
...
<body>
	...
	<div id="nav" class="btn-group">
		<span class="label label-default">优惠券管理</span>
	</div>
	<div id="fun" class="btn-group" data-toggle="buttons-checkbox">
		<button class="btn btn-primary" id="add_coupon_manager"
			style="float: left">新增</button>
		<button class="btn btn-primary" id="query_coupon_manager"
