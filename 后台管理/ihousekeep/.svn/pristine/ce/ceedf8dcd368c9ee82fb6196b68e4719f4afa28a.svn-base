...
<title>东学家政上门服务后台登录 </title>
<meta name="renderer" content="webkit">
<meta http-equiv="X-UA-Compatible" content="IE=Edge,chrome=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<script type="text/javascript" src="js/jquery.js"></script>
<script src="js/base.js" type="text/javascript"></script> 
<link type="text/css" href="ihouseweb/css/Login.css" rel="stylesheet" />
<link href="ihouseweb/css/Style.css" rel="stylesheet" />
<script type="text/javascript" src="ihouseweb/js/Login.js"></script> 
</head>
...
<div class="login_wrap" style="width:; background:#fff url(ihouseweb/images/20161209115754_5628.jpg) no-repeat center top; padding:40px 0;">
			...
			<div class="login" style="display: block;">
				...
				<!-- 用于实现页面跳转 -->
					<div class="login-style" style="display: block;">
						<dl><dd><input name="txtUser" type="text" id="txtUser" value ="" placeholder="用户名/邮箱/手机号" /></dd></dl>
						<dl>
							<dd><input type="password" id="Userpwd" value=""  placeholder="请输入您的密码" /></dd>
						</dl>
						<div class="remember">
