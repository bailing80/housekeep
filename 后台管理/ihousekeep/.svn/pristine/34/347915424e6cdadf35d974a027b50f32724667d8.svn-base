...
@Controller
@RequestMapping("T_u_apartment_type_Controller")
public class T_u_apartment_type_Controller extends BaseMultiController {
@Resource
public T_u_apartment_type_Service_Iface t_u_apartment_type_service_iface;
