...
public class T_u_rider extends Base_Model_Business {
private String pwd;
...
private String on_time_str ;
public void setOn_time_str(String on_time_str ){
this.on_time_str =on_time_str;
}
public String  getOn_time_str (){
return this.on_time_str ;
}
...
private String off_time_str ;
public void setOff_time_str(String off_time_str ){
this.off_time_str =off_time_str;
}
