...
<script type="text/javascript" src="<%=baseurl%>/html/main/advertisement_item/advertisement_item.js"></script>
...
%> 
	<div id="nav" class="btn-group">
		<span class="label label-default">设置广告</span>
	</div>
	<div id="fun" class="btn-group" data-toggle="buttons-checkbox">
		<button class="btn btn-primary" id="add_advertisement_item" style="float: left">新增</button>
		<button class="btn btn-primary" id="delete_advertisement_item">删除</button>
		<button class="btn btn-primary" id="query_advertisement_item" style="float: left">查询</button>
