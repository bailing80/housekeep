...
<script src="<%=baseurl%>/html/main/data/update_data.js"></script>
</head>
<body>
	<table border="1" class="table table-striped" style="width: 100%">
		<tr>
			<td>经度</td>
			<td><input id="longitude" type="text" size="2"
				class="form-control" style="width: 30%"></td>
		</tr>
		<tr>
			<td>纬度</td>
			<td><input id="latitude" type="text" size="2"
				class="form-control" style="width: 30%"></td>
		</tr>
		<tr>
			<td>点的颜色</td>
			<td><input id="color" type="text" size="2"
				class="form-control" style="width: 30%"></td>
		</tr>
		<tr>
			<td>备注</td>
			<td><input id="message" type="text" size="2"
				class="form-control" style="width: 30%"></td>
		</tr>
	</table>
</body>
