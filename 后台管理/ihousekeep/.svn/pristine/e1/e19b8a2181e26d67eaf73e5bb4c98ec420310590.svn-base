...
@Service("T_u_coupon_type_Service")
@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
public class T_u_coupon_type_Service_Impl extends BaseService implements T_u_coupon_type_Service_Iface {
@Resource
...
t_u_coupon_type_dao_iface.insert_t_u_coupon_type(t_u_coupon_type);
}
public void update_t_u_coupon_type(T_u_coupon_type t_u_coupon_type) throws Exception{
t_u_coupon_type_dao_iface.update_t_u_coupon_type(t_u_coupon_type);
}
public void delete_t_u_coupon_type(T_u_coupon_type t_u_coupon_type) throws Exception{
t_u_coupon_type_dao_iface.delete_t_u_coupon_type(t_u_coupon_type);
}
public List queryAll_t_u_coupon_type(T_u_coupon_type t_u_coupon_type) throws Exception{
return t_u_coupon_type_dao_iface.queryAll_t_u_coupon_type(t_u_coupon_type);
}
public List queryBy_t_u_coupon_type(T_u_coupon_type t_u_coupon_type) throws Exception{
return t_u_coupon_type_dao_iface.queryBy_t_u_coupon_type(t_u_coupon_type);
}
}