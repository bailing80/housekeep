package com.ccunix.ihousekeeping.t_lz_systemacct.service;
...
import com.ccunix.ihousekeeping.t_lz_systemacct.dao.T_lz_systemacct_Dao_Iface_r;

@Service("T_lz_systemacct_Service")
@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
public class T_lz_systemacct_Service_Impl_r extends BaseService implements T_lz_systemacct_Service_Iface_r {
@Resource
public T_lz_systemacct_Dao_Iface_r t_lz_systemacct_dao_iface;
...
public void delete_t_lz_systemacct(T_lz_systemacct_r t_lz_systemacct) throws Exception{
	...
	try {
		...
		for (String string : ids) {
			T_lz_systemacct_r t = new T_lz_systemacct_r();
			t.setId(string);
