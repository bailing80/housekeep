...
<body>
	<table border="1" class="table table-striped" style="width: 100%">
		...
		<tr>
			<td>APPID</td>
			<td><input id="app_id" type="text" readonly="readonly" size="2" class="form-control"
				style="width: 30%"></td>
		</tr>
		<tr>
			<td>商户私钥</td>
			<td><input id="merchant_private_key" readonly="readonly" type="text" size="2" class="form-control"
				style="width: 30%"></td>
		</tr>
		<tr>
			<td>支付宝公钥</td>
			<td><input id="alipay_public_key" type="text" readonly="readonly" size="2" class="form-control"
				style="width: 30%"></td>
		</tr>
		<tr>
			<td>异步通知路径</td>
			<td><input id="notify_url" type="text" readonly="readonly" size="2" class="form-control"
				style="width: 30%"></td>
		</tr>
		<tr>
			<td>同步通知路径</td>
			<td><input id="return_url" type="text" readonly="readonly" size="2" class="form-control"
				style="width: 30%"></td>
		</tr>
		<tr>
			<td>签名方式</td>
			<td><input id="sign_type" type="text" readonly="readonly" size="2" class="form-control"
				style="width: 30%"></td>
		</tr>
		<tr>
			<td>字符编码格式</td>
			<td><input id="charset" type="text" readonly="readonly" size="2" class="form-control"
				style="width: 30%"></td>
		</tr>
		<tr>
			<td>支付宝网关</td>
			<td><input id="gatewayurl" type="text" readonly="readonly" size="2" class="form-control"
				style="width: 30%"></td>
		</tr>
		<tr>
			<td>支付宝数据格式</td>
			<td><input id="zfbchar" type="text" readonly="readonly" size="2" class="form-control"
				style="width: 30%"></td>
		</tr>
	</table>
</body>
