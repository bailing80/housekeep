...
<script type="text/javascript" src="<%=baseurl%>/html/main/business_group/update_business.js"></script>
</head>
<body>
<div id="content">
		...
		<tr>
			<td>支付宝或者微信</td>
			<td style="text-align: left;"><input type="radio" id="alipay" name="is_enable" value="A01" style="transform:scale(1.2);width:20px;" \">支付宝<input type="radio" id="wxpay" name="is_enable" value="A02"  style="transform:scale(1.2);width:20px;">微信
			</td>
		</tr>
