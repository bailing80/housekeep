...
<script type="text/javascript" src="<%=baseurl%>/html/main/saler/saler.js"></script>
...
<body>
	...
	<div id="fun" class="btn-group" data-toggle="buttons-checkbox">
		<button class="btn btn-primary" id="add_saler" style="float: left">新增</button>
		<button class="btn btn-primary" id="delete_saler">批量删除</button>
	</div>
	<div id="content">
