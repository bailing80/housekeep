...
@Controller
@RequestMapping("T_lz_receive_acct_Controller")
public class T_lz_receive_acct_Controller extends BaseMultiController {
@Resource
public T_lz_receive_acct_Service_Iface t_lz_receive_acct_service_iface;
