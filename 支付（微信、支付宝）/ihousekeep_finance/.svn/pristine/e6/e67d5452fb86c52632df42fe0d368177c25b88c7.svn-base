...
@Service("T_lz_zfb_info_Service")
@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
public class T_lz_zfb_info_Service_Impl extends BaseService implements T_lz_zfb_info_Service_Iface {
@Resource
...
t_lz_zfb_info_dao_iface.delete_t_lz_zfb_info(t_lz_zfb_info);
}
public List queryAll_t_lz_zfb_info(T_lz_zfb_info t_lz_zfb_info) throws Exception{
return t_lz_zfb_info_dao_iface.queryAll_t_lz_zfb_info(t_lz_zfb_info);
}
public List queryBy_t_lz_zfb_info(T_lz_zfb_info t_lz_zfb_info) throws Exception{
return t_lz_zfb_info_dao_iface.queryBy_t_lz_zfb_info(t_lz_zfb_info);
}
}