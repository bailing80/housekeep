...
<script type="text/javascript" src="<%=baseurl%>/html/main/receive_acct/receive_acct.js"></script>
...
<body>
	<div id="nav" class="btn-group">
		<span class="label label-default">加盟商管理</span>
	</div>
	<div id="fun" class="btn-group" data-toggle="buttons-checkbox">
		<button class="btn btn-primary" id="add_receive_acct" style="float: left">新增</button>
		<button class="btn btn-primary" id="delete_receive_acct">批量删除</button>
		<button class="btn btn-primary" id="query_receive_acct" style="float: left">查询</button>
