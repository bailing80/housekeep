...
@Controller
@RequestMapping("T_lz_receive_type_Controller")
public class T_lz_receive_type_Controller extends BaseMultiController {
@Resource
public T_lz_receive_type_Service_Iface t_lz_receive_type_service_iface;
