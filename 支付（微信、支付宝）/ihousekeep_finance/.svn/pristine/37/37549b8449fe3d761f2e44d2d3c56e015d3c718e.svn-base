...
@Controller
@RequestMapping("T_lz_order_Controller")
public class T_lz_order_Controller extends BaseMultiController {
@Resource
public T_lz_order_Service_Iface t_lz_order_service_iface;
